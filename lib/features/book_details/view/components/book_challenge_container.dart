      ...
      children: [
        Row(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                SizedBox(width:240.w,child: AutoSizeText(maxLines: 1,"challenge_your_self".t(context),style: StylesConsts.f23W600Yellow,)),
               10.spaceH,
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            20.spaceW,
            (book.isChallenged)?
            JoinBookChallengeBuilder( bookId: book.id,):const BookDetailsButton(buttonText: 'joined')
          ],
        ).verticalPadding,
      ],
    );
